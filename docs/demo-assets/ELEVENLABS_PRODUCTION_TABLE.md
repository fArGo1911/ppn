...
## 🔥 Record this first — tiny smoke pack (`P0 smoke`)

Just **four files** — record these before anything else to test the voice, naming, upload and playback flow. Don't record the full P1 pack until these sound right.

| # | cueId | filename | purpose | tag | scriptText |
| --- | --- | --- | --- | --- | --- |
| 1 | intro-welcome | intro-welcome.mp3 | event/venue/sponsor tone | P0 smoke | Good evening and welcome to O'Learys for tonight's quiz, brought to you by Fuller's. Scan the QR code on your table, give your team a name, and answer on your phone — one shared answer per team. Please drink responsibly. Phones ready — let's play! |
| 2 | q01-readout | playlist-demo-q01-readout.mp3 | question audio | P0 smoke | How many continents are there? |
| 3 | a-leadin-01 | a-leadin-01.mp3 | modular answer-review assembly | P0 smoke | Question number one. |
| 4 | a01-answer | playlist-demo-a01-answer.mp3 | short answer audio | P0 smoke | Seven. |

**How to record the smoke pack:**

1. Record these four files first.
2. Use the **same** ElevenLabs voice (British pub host) for all four.
3. One row = one MP3.
4. Download each file.
5. Rename it **exactly** to the filename above.
6. Upload / test them in PPN.
7. Do **not** record the full P1 pack until these four sound right.
...
| cueId | filename | family | phase | priority | smoke | scope | status | playback | scriptText |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| intro-welcome | intro-welcome.mp3 | global | intro | P1 core demo | P0 smoke | market-specific | ready-to-record | standalone | Good evening and welcome to O'Learys for tonight's quiz, brought to you by Fuller's. Scan the QR code on your table, give your team a name, and answer on your phone — one shared answer per team. Please drink responsibly. Phones ready — let's play! |
...
| cueId | filename | family | phase | priority | smoke | scope | status | playback | scriptText |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| q01-readout | playlist-demo-q01-readout.mp3 | question-readout | question-phase | P1 core demo | P0 smoke | reusable | ready-to-record | question-content | How many continents are there? |
...
| cueId | filename | family | phase | priority | smoke | scope | status | playback | scriptText |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| a-leadin-01 | a-leadin-01.mp3 | answer-leadin | answer-review-phase | P1 core demo | P0 smoke | reusable | ready-to-record | lead-in | Question number one. |
...
| cueId | filename | family | phase | priority | smoke | scope | status | playback | scriptText |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| a01-answer | playlist-demo-a01-answer.mp3 | answer-content | answer-review-phase | P1 core demo | P0 smoke | reusable | ready-to-record | answer-content | Seven. |
...
## How Ian records the full pack in ElevenLabs

1. Use the chosen ElevenLabs voice (British pub host).
2. Record the **smoke pack** first, then the **P1 (record first)** rows.
3. One row = one MP3.
...
**Totals:** 55 rows · 49 recordable MP3s · **4 P0 smoke** · 21 P1 files.
